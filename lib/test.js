...
function testEmptyOrNull() {
  ...
  const output = transform(outputTemplate, data);
  const output2 = transform(outputTemplate, data2);
  const output3 = transform(outputTemplate, data3);
  const output4 = transform(outputTemplate, data4);

  console.log('output with field values = ' + JSON.stringify(output, null, 2));
  console.log('output with null field values = ' + JSON.stringify(output2, null, 2));
  console.log('output with empty string field values = ' + JSON.stringify(output3, null, 2));
  console.log('output with no field values = ' + JSON.stringify(output4, null, 2));
  return output;
}

module.exports = test;
module.exports.testEmptyOrNull = testEmptyOrNull;
